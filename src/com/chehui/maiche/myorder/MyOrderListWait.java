...
import com.chehui.maiche.myorder.MyOrderListAll.MessageReceiver;
 ...
 * 
 */
public class MyOrderListWait extends BaseActivity implements OnRefreshListener,
	...
	private void initViews() {
		...
		tv_empty.setText(getResources().getString(R.string.main_order_wait));
	...
	private void getMyOrderData(final String conParams, final int type) {
		...
		new AsyncTask<Void, Integer, String>() {
			...
			protected String doInBackground(Void... params) {
				...
				LogN.e(MyOrderListWait.this, "查看参数类型" + parameters.toString());
			...
			protected void onPostExecute(String result) {
				...
				if (result != null) {
					...
					ToastUtils.showShortToast(MyOrderListWait.this, "暂无数据!");
				}
			}
	...
	private void analysisJson(int type) {
		...
		try {
			...
			if (jsonArray.length() != 0) {
				...
				LogN.e(MyOrderListWait.this, "jsonArray="+jsonArray.length());
				LogN.e(MyOrderListWait.this, "tempList="+tempList.size());
				LogN.e(MyOrderListWait.this, "list.size="+list.size());
				if (adapter == null) {
					adapter = new MyOrderListAdapter(MyOrderListWait.this, list);
	...
	public void onLoad() {
		params = sellerid + "|" + state + "|" + String.valueOf(++currentPage);
		LogN.e(MyOrderListWait.this, "onLoad ====="+params);
	...
	public void onRefresh() {
		currentPage = 1;
		params = sellerid + "|" + state + "|" + String.valueOf(currentPage);
		LogN.e(MyOrderListWait.this, "onRefresh ====="+params);
	...
	public class MessageReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			if (CommonData.MESSAGE_RECEIVED_ACTION.equals(intent.getAction())) {
				LogN.e(this, " MyOrderListWait is  on  receiver!!!!");
				currentPage=1;
				params = sellerid + "|" + state + "|" + String.valueOf(currentPage);
				getMyOrderData(params, AutoListView.REFRESH);
			}
