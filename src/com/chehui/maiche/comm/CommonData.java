...
public class CommonData {
	...
	public static final String UPDATE_RECEIVED_ACTION = "com.chehui.maiche.MESSAGE_RECEIVED_ACTION";
	public static final String BAOJIA_RECEIVED_ACTION = "com.chehui.maiche.MESSAGE_RECEIVED_ACTION";
	...
	/** 用户信息 提交安全认证 */
	public static boolean MODIFYVIPLEVEL ;
	...
	/** 用户信息修改参数 */
	public static final String INFOPARAMS = "INFOPARAMS";
	...
	public static int BAOJIANUMBER;
}
