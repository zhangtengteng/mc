...
//				ToastUtils.showShortToast(getActivity(), "onLoad");
	...
	private void getBaojia() {
		String arg = sellbrand1 + "|" + sellbrand1 + "|" + sellbrand1 + "|"
				+ testCityname + "|" + sellerid;
		getBaojiaNum(arg);
	}
	...
	private void initData() {
		...
		Log.d(TAG + "查询价的提交信息",
				sellbrand1 + sellbrand2 + sellbrand3 + cityname.trim()
						+ sellerid + String.valueOf(page));

		testCityname = cityname.replaceAll(" ", "");

		postParams = sellbrand1 + "|" + sellbrand1 + "|" + sellbrand1 + "|"
				+ testCityname + "|" + sellerid + "|" + String.valueOf(page);
			...
			protected void onPostExecute(String result) {
				if (result != null) {
					...
					try {
						...
						System.out
								.println("CommonData.BAOJIANUMBER==============================="
										+ CommonData.BAOJIANUMBER);
						if (CommonData.tvNumber != null) {

							if (CommonData.BAOJIANUMBER > 0) {
								CommonData.tvNumber.setVisibility(View.VISIBLE);
								CommonData.tvNumber.setText(String
										.valueOf(CommonData.BAOJIANUMBER));
							} else {
								CommonData.tvNumber
										.setVisibility(View.INVISIBLE);
							}
						} else {
							LogN.e(OrderCheckFragment.this,
									"CommonData.tvNumber is null!!!!");
						}
	...
	private class EqOrderAdapter extends BaseAdapter {
		...
		public void setData(List<Map<String, String>> listTOder) {
			...
			LogN.d(OrderCheckFragment.this,
					"adapter is notifyDataSetChanged!!!");
		}
	...
	public class MessageReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			if (CommonData.MESSAGE_RECEIVED_ACTION.equals(intent.getAction())) {
				LogN.e(OrderCheckFragment.this,
						"OrderCheckFragment is onReceive!!!!");
				getOrderByBrands(postParams, AutoListView.REFRESH);
				getBaojia();
			}
		}
