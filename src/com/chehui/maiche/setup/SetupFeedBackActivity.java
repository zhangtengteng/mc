		...
		if (StringUtils.isEmpty(tv_FeedBack.getText().toString().trim())) {
			...
			new AsyncTask<Void, Integer, String>() {
				...
				protected String doInBackground(Void... params) {
					...
					parameters.add(new BasicNameValuePair("methodname", "AddAdvice"));
					parameters.add(
							new BasicNameValuePair("params", userID + "|" + tv_FeedBack.getText().toString().trim()));
				...
				protected void onPostExecute(String result) {
					if (result.toString().equals("true")) {
						startActivity(new Intent(SetupFeedBackActivity.this, SetupFeedbackSuccess.class));
						finish();
					} else {
