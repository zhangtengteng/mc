...
//			break;
	...
	private void showCustomUI() {
		...
		PoPShareWindowManager.getInstance().init(getApplicationContext(),
				width, LayoutParams.WRAP_CONTENT, R.layout.pop_share_wechat);
