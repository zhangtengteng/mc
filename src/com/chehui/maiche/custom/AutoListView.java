...
public class AutoListView extends ListView implements OnScrollListener {
	...
	public static final int FIRSTLOAD = 1000;
	...
	private int pageSize = CommonData.pageSize;
	...
	private void initView(Context context) {
		...
		footer = inflater.inflate(R.layout.autolistview_listview_footer, null);
...
//		loading.setVisibility(View.GONE);
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		...
		CommonData.currentPage = totalItemCount % CommonData.pageSize == 0 ? totalItemCount / CommonData.pageSize
				: totalItemCount / CommonData.pageSize + 1;
	}
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		...
		if(moveY>-200){
			LogN.e(AutoListView.this, "moveY<-200********不可以加载"+moveY);
		}else{
			LogN.e(AutoListView.this, "moveY>-200********可以加载"+moveY);
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_UP:
			...
			LogN.e(AutoListView.this, " ev.getY() ***************"+ ev.getY() );
			LogN.e(AutoListView.this, " up 距离**************"+ moveY);
			break;
		case MotionEvent.ACTION_MOVE:
			/*float moveY = ev.getY() - startY;//y轴距离
			LogN.e(AutoListView.this, "moveY-******************************"+moveY);
			LogN.e(AutoListView.this, " ev.getY() ***********"+ ev.getY() );
			LogN.e(AutoListView.this, " startY*******************"+ startY);*/
			whenMove(ev);
			break;
		}
